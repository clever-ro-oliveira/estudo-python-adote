...
def listar_pets(request):
    if request.method == "GET":
        ...
        return render(request, 'listar_pets.html', {'pets': pets, 'racas': raca, 'cidade': cidade, 'raca_filter': raca_filter})
...
def processa_pedido_adocao(request, id_pedido):
    ...
    if status == "A":
        ...
        messages.add_message(request, constants.ERROR, 'Pedido não processado - Status inválido')
